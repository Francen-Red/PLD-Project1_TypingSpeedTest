...
def display_text(stdscr, target, current, wpm=0):   
    ...
    stdscr.addstr(6, 0, f"WPM: {wpm}")              #Display the current WPM at row 6, column 0
...
#Create a while loop to continuously run the typing test
    ...
    while True:
        ...
        display_text(stdscr, target_text, current_text, wpm)  #Display the target text on the screen 
        stdscr.refresh()                                      #Ask the user to enter a key
